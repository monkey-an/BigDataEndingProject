...
public class TotalPriceGroupBySexCount {
        ...
        originalData.foreachRDD(rdd -> {
            rdd.foreachPartition(pdata -> {
                ...
                while (pdata.hasNext()) {
                    ...
                    if (!"".equals(sexStr))
                        JedisUtils.hincrByDouble(clickHashKey, sexStr, new BigDecimal(t.getPrice()).multiply(new BigDecimal(t.getQty())).doubleValue());
                }
